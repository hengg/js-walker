...
- 状态的总数是有限的，所有的状态，保存在一个对象里面。
- 特定情况下状态可以发生转换。

Redux 通过定义 Action 和 Reducer 把应用组织成了一个状态机。

[阮一峰：JavaScript与有限状态机](http://www.ruanyifeng.com/blog/2013/09/finite-state_machine_for_javascript.html)
...
```json
{
    "name": "react-learning",
    "version": "0.0.1",
    "description": "Learning react with redux,webpack and babel.",
    "author": "hengg",
    "license": "MIT",
    "main": "app/main.js",
    "scripts": {
    ...
    loaders: [
      {
        ...
        query: {
          presets: ['es2015','react']//es2015是ES6的官方称呼
        }
      }
    ]
  }
